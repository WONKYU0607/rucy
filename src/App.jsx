...
const ALLY_DEFS = {
  hunter: {
    name: '헌터', h: 68, xOff: -85, yOff: 23, atkMult: 0.45, cd: 1.15, range: 470,
  ...
  healer: {
    ...
    name: '힐러', kind: 'buff', buff: 0.05, h: 60, xOff: -100, yOff: -5,
    walk: [1, 2, 3, 4, 5, 6, 7, 8].map(i => `/ally/healer/heal_${i}.png`),
    atk: [],
  },
  giant: {
    // 근접 주먹 — 투사체 없이 히어로 타격 순간에 맨 앞 적을 직접 타격
    name: '거인', kind: 'melee', h: 150, xOff: -130, yOff: -2, atkMult: 0.8, range: 360,
    atkDur: 0.5,
